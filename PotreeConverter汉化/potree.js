...
function initToolbar(){
	...
	elToolbar.append(createToolIcon(
		...
		function(){viewer.volumeTool.startInsertion({name:"体积测量结果"})}
	));
	...
	elToolbar.append(createToolIcon(
		...
		function(){
			$("#menu_measurements").next().slideDown();;
			viewer.profileTool.startInsertion({name:"等高线"});
		}
	));
	...
	elToolbar.append(createToolIcon(
		...
		function(){viewer.volumeTool.startInsertion({clip: true,name:"体积测量夹"})}
	));
...
function initClassificationList(){
	...
	addClassificationItem(0, "未分类");
	addClassificationItem(1, "不进行分类");
	addClassificationItem(2, "地面");
	addClassificationItem(3, "草丛");
	addClassificationItem(4, "灌木");
	addClassificationItem(5, "乔木");
	addClassificationItem(6, "建筑");
	addClassificationItem(7, "低噪点");
	addClassificationItem(8, "关键点");
	addClassificationItem(9, "水体");
	addClassificationItem(12, "复合点");
}
		...
		
		{
			...
			let elDownload = $(`
				<a href="#" download="measure.dxf" class="measurepanel_downloads">
					<img src="${icon}" style="height: 24px" /></a>
				`);
			elActionsB.append(elDownload);
...
function initSceneList(){
	...
	let initUIElements = function(i) {
			...
			<span class="scene_item">
				...
				<div class="scene_content selectable" style="display: none">
					<div>
						...
						<!-- SIZE TYPE -->
						<li>
							<label for="optPointSizing_${i}" class="pv-select-label" data-i18n="appearance.point_size_type">点样式</label>
							<select id="optPointSizing_${i}" name="optPointSizing_${i}">
								<option value="FIXED">固定</option>
								<option value="ATTENUATED">加厚</option>
						...
						<li>
							...
							<select id="optShape_${i}" name="optShape_${i}">
								...
								<option value="PARABOLOID">菱形</option>
							</select>
						</li>	
						...
						<div id="materials.composite_weight_container${i}">
							...
							<li>强度: <span id="lblWeightIntensity${i}"></span> <div id="sldWeightIntensity${i}"></div>	</li>
							<li>高程: <span id="lblWeightElevation${i}"></span> <div id="sldWeightElevation${i}"></div>	</li>
							<li>分类: <span id="lblWeightClassification${i}"></span> <div id="sldWeightClassification${i}"></div>	</li>
							<li>回波数: <span id="lblWeightReturnNumber${i}"></span> <div id="sldWeightReturnNumber${i}"></div>	</li>
							<li>资源序号: <span id="lblWeightSourceID${i}"></span> <div id="sldWeightSourceID${i}"></div>	</li>
						</div>
						...
						<div id="materials.rgb_container${i}">
							...
							<li>灰度: <span id="lblRGBGamma${i}"></span> <div id="sldRGBGamma${i}"></div>	</li>
							<li>亮度: <span id="lblRGBBrightness${i}"></span> <div id="sldRGBBrightness${i}"></div>	</li>
							<li>色差: <span id="lblRGBContrast${i}"></span> <div id="sldRGBContrast${i}"></div>	</li>
						</div>
						...
						<div id="materials.transition_container${i}">
							...
							<li>渐变: <span id="lblTransition${i}"></span> <div id="sldTransition${i}"></div>	</li>
						</div>
						...
						<div id="materials.intensity_container${i}">
							...
							<li>范围: <span id="lblIntensityRange${i}"></span> <div id="sldIntensityRange${i}"></div>	</li>
							<li>灰度: <span id="lblIntensityGamma${i}"></span> <div id="sldIntensityGamma${i}"></div>	</li>
							<li>亮度: <span id="lblIntensityBrightness${i}"></span> <div id="sldIntensityBrightness${i}"></div>	</li>
							<li>色差: <span id="lblIntensityContrast${i}"></span> <div id="sldIntensityContrast${i}"></div>	</li>
						</div>
		...
		let updateHeightRange = function(){
			...
			$( "#lblHeightRange" + i )[0].innerHTML = pcMaterial.heightMin.toFixed(2) + " 到 " + pcMaterial.heightMax.toFixed(2);
			$( "#sldHeightRange" + i ).slider({
				min: bMin,
				max: bMax,
		...
		let updateIntensityRange = function(){
			...
			$( "#lblIntensityRange" + i )[0].innerHTML = 
				parseInt(pcMaterial.intensityRange[0]) + " 到 " + 
